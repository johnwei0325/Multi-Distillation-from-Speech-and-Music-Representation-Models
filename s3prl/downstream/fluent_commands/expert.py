...
from ..model import *
from .dataset import FluentCommandsDataset, FluentCommandsWithSingerDataset
...
class DownstreamExpert(nn.Module):
    ...
    def get_dataset(self):
        ...
        self.train_csv_path = self.datarc['train_csv_path']
        #train_df = pd.read_csv(os.path.join(self.base_path, "data", "train_data.csv"))
        train_df = pd.read_csv(os.path.join(self.train_csv_path))
