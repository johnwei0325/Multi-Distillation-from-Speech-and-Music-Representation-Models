...
if __name__ == "__main__":
  ...
  os.makedirs("../vocalset_technique_id/data", exist_ok=True)
  np.savetxt('../vocalset_technique_id/data/train_t.txt', train_df.file_name, fmt='%s')
  np.savetxt('../vocalset_technique_id/data/valid_t.txt', valid_df.file_name, fmt='%s')
  np.savetxt('../vocalset_technique_id/data/test_t.txt', test_df.file_name, fmt='%s')
  ...
  np.savetxt('./data/train_s.txt', train_df.file_name, fmt='%s')
  np.savetxt('./data/valid_s.txt', valid_df.file_name, fmt='%s')
  np.savetxt('./data/test_s.txt', test_df.file_name, fmt='%s')
