...
from ..model import *
from .dataset import SpeechCommandsDataset, SpeechCommandsTestingDataset, CLASSES, SpeechCommandsTestingWithSingerDataset
...
class DownstreamExpert(nn.Module):
    ...
    def __init__(self, upstream_dim: int, downstream_expert: dict, expdir: str, **kwargs):
        ...
        #self.test_dataset = SpeechCommandsTestingWithSingerDataset(**self.datarc)
        print('========================================', self.datarc["speech_commands_root"])
