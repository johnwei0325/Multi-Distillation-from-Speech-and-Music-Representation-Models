...
class Runner():
    ...
    def _get_upstream(self):
        ...
        if not isinstance(self.args.upstream_model_config, dict):
            with open(self.args.upstream_model_config, 'r') as file:
                self.args.upstream_model_config = yaml.load(file, Loader=yaml.FullLoader)
        print('==========================',self.args.upstream_model_config, '=======================')
        model = Upstream(
            ckpt = ckpt_path,
